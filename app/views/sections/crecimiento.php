...
<!-- LEFT --><div class="left">
		...
		<!-- SLIDER --><div class="slider-contenido">
							...
							<div class="container">
								<div class="ph">
									<img src="contenido/img/crecimiento1.jpg" />
								</div>
								<div class="ph">
									<img src="contenido/img/crecimiento2.jpg" />
								</div>
							</div>
		<!-- END SLIDER --></div>

						<div class="data">
							<p>Desde su nacimiento, <strong>San Fernando</strong> sumó una gran cantidad de pobladores y, aunque creció menos que el resto, era por entonces el tercer partido más habitado de los que rodeaban la Capital Federal. Nuestro Partido también se llenó de inmigrantes. De cada diez habitantes del pueblo, tres o cuatro eran extranjeros y la mayoría, con el correr de los años, empezaron a poblar las islas. Cuando en ellas empezaron a fundarse las primeras escuelas, muchos de los maestros y maestras eran franceses, italianos y españoles.
 <br/><br/>
...
En el año 1891, se inauguró la estación de tren con el nombre de Victoria. A sus alrededores, se formó inmediatamente un nuevo pueblo que, desde entonces, lleva la misma denominación que la estación. Junto a ella, se levantaron los primeros galpones y talleres ferroviarios que atrajeron gran cantidad de trabajadores que se convirtieron en los primeros pobladores de la localidad de Victoria.
 <br/><br/>
Con el correr de los años, Las Islas Del Delta comenzaron a poblarse. Muchos inmigrantes, formaron pequeñas colonias en las riberas de los ríos y arroyos. Se fundaron escuelas y creció la actividad fruti hortícola, la plantación de mimbres, la explotación forestal y la cría de ovejas y aves.
 <br/><br/>
Una compañía instaló en el Pueblo una red de agua corriente la cual, lentamente, se fue extendiendo. El agua, que se guardaba en grandes tanques en el centro, se distribuía a través de una red de cañerías lo cual sirvió para adelantar muchas tareas.
 <br/><br/>
La gran cantidad de avances que presentaba San Fernando, provocó un crecimiento en la Industria con la instalación de aserraderos, carpinterías y talleres navales. Además, surgieron las compañías de navegación que realizaban viajes periódicos a las Islas y se aumentó la actividad comercial en todos sus aspectos.
 <br/><br/>
Sin dudas, <strong>SAN FERNANDO</strong>, logró un importante desarrollo que lo convierte en un Pueblo avanzado en varios frentes.</p>
